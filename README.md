...
If are working with [encrypted forms](http://docs.opendatakit.org/encrypted-forms) you may get an `InvalidKeyException`. This is because you do not have an unlimited crypto policy enabled in Java. Do this:
