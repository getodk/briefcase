...
public class WorkspaceHelper {
  ...
  public static Workspace inMemory() {
    return Workspace.with(new InMemoryHttp(), null, InMemoryPreferences.empty(), null, new InMemoryFormMetadataAdapter(), new InMemorySubmissionMetadataAdapter());
  }

  public static Workspace inMemory(Http http) {
    return Workspace.with(http, null, InMemoryPreferences.empty(), null, new InMemoryFormMetadataAdapter(), new InMemorySubmissionMetadataAdapter());
  }
}
