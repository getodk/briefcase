...
public class FormMetadataCommandsTest {
  ...
  public void setUp() {
    ...
    FormMetadata formMetadata = new FormMetadata(key, Optional.of("Some form"), Optional.of(formFile), Cursor.empty(), false, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
  ...
  private FormMetadata buildFormMetadata(int number) {
    ...
    return new FormMetadata(key, Optional.of("Form " + number), Optional.of(formFile), Cursor.from("some cursor data"), false, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
  }
}
