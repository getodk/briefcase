...
public class CsvSubmissionMappersHeadersTest {
  ...
  public void produces_a_header_for_the_main_file() {
    FormModel model = instance(group("group", text("field"))).build();
  ...
  public void produces_a_header_for_a_repeat_file() {
    FormModel repeat = instance(repeat("repeat", group("group", text("field")))).build().getChildByName("repeat");
  ...
  public void supports_splitting_select_multiple_fields() {
    ...
    FormModel model = instance(selectMultiple("select", choice1, choice2)).build();
    ...
    FormModel repeat = instance(repeat("some-repeat", selectMultiple("select", choice1, choice2))).build().getChildByName("some-repeat");
  ...
  public void supports_splitting_select_multiple_fields_in_groups() {
    ...
    FormModel model = instance(group("some-group", selectMultiple("select", choice1, choice2))).build();
    ...
    assertThat(getMainHeader(model, false, true, true), is("SubmissionDate,select,select/some value 1,select/some value 2,KEY"));
    assertThat(getMainHeader(model, true, true, true), is("SubmissionDate,select,select/some value 1,select/some value 2,KEY,isValidated"));
    FormModel repeat = instance(repeat("some-repeat", group("some-group", selectMultiple("select", choice1, choice2)))).build().getChildByName("some-repeat");
