...
public final class XFormParameters implements Comparable<Object>, Serializable {
  ...
  public String toString() {
    return "XFormParameters[formId=" + formId + " and version=" + (modelVersion == null
        ? "null"
        : Long.toString(modelVersion)) + " and uiVersion=null]";
  }
  ...
  public boolean equals(Object obj) {
    ...
    return formId.equals(p.formId) && ((modelVersion == null)
        ? p.modelVersion == null
  ...
  @Override
  public int hashCode() {
    return Long.valueOf(formId.hashCode() + ((modelVersion == null) ? 20480L : 37 * modelVersion)).hashCode();
  }
