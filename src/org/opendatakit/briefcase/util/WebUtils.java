...
public final class WebUtils {
   ...
   */
  public static void setCredentials(HttpClientContext httpContext,
  ...
  public static final boolean hasCredentials(HttpClientContext localContext, String userEmail, String host) {
    CredentialsProvider credsProvider = localContext.getCredentialsProvider();
  ...
  private static final void setOpenRosaHeaders(HttpRequest req) {
    ...
    req.setHeader(DATE_HEADER, org.apache.http.client.utils.DateUtils.formatDate(new Date(),
