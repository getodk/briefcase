...
public class FormTransferTable extends JTable {
  ...
  public class JTableButtonMouseListener implements MouseListener {
    ...
    public void mouseClicked(MouseEvent e) {
      ...
      if (row < FormTransferTable.this.getRowCount() && row >= 0 && column < FormTransferTable.this.getColumnCount()
          && column >= 0) {
  ...
  public static class DetailButton extends JButton implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      try {
        ...
        setEnabled(false);
        ScrollingStatusListDialog.showDialog(JOptionPane.getFrameForComponent(this), status.getFormDefinition(),
            history);
      } finally {
        setEnabled(true);
      }
  ...
  static class FormTransferTableModel extends AbstractTableModel {
    ...
    public FormTransferTableModel(JButton btnSelectOrClearAllForms,
      ...
      this.columnNames = new String[] {"Selected", "Form Name",
          ((transferType == TransferType.UPLOAD) ? PushTransferPanel.TAB_NAME : PullTransferPanel.TAB_NAME) + " Status",
          DetailButton.LABEL};
  ...
  public FormTransferTable(JButton btnSelectOrClearAllForms,
                           FormStatus.TransferType transferType,
                           JButton btnTransfer,
                           JButton btnCancel) {
    ...
    Component comp = headerRenderer.getTableCellRendererComponent(null, columns.getColumn(0).getHeaderValue(), false,
        false, 0, 0);
