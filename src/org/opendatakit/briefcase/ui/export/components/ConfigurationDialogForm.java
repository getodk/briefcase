...
public class ConfigurationDialogForm extends JDialog {
  ...
  public ConfigurationDialogForm(ConfigurationPanel confPanel) {
    configurationPanelForm = confPanel.getForm();
    $$$setupUI$$$();
    ...
    okButton.setEnabled(confPanel.isValid());
    removeButton.addActionListener(e -> dispose());
    removeButton.setEnabled(!confPanel.getConfiguration().isEmpty());
    cancelButton.addActionListener(e -> dispose());

    confPanel.onChange(() -> okButton.setEnabled(confPanel.getConfiguration().isValid()));
  ...
  private void $$$setupUI$$$() {
    ...
    gbc.fill = GridBagConstraints.HORIZONTAL;
    dialog.add(container, gbc);
    container.add(configurationPanelForm.$$$getRootComponent$$$(), "Card1");
