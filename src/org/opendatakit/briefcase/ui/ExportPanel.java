...
public class ExportPanel extends JPanel {
  ...
  public class DetailButton extends JButton implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      try {
        setEnabled(false);
        ScrollingStatusListDialog.showExportDialog(JOptionPane.getFrameForComponent(this), form, dirName, history);
      } finally {
        setEnabled(true);
      }
    }
  ...
  class ExportActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (exportDir == null || exportDir.trim().length() == 0) {
        ODKOptionPane.showErrorDialog(ExportPanel.this, TAB_NAME + " directory was not specified.",
            MessageStrings.INVALID_EXPORT_DIRECTORY);
        return;
      }
      File exportDirectory = new File(exportDir.trim());
      if (!exportDirectory.exists()) {
        ODKOptionPane.showErrorDialog(ExportPanel.this, MessageStrings.DIR_NOT_EXIST,
            MessageStrings.INVALID_EXPORT_DIRECTORY);
        return;
      }
      if (!exportDirectory.isDirectory()) {
        ODKOptionPane.showErrorDialog(ExportPanel.this, MessageStrings.DIR_NOT_DIRECTORY,
            MessageStrings.INVALID_EXPORT_DIRECTORY);
        return;
      }
      if (FileSystemUtils.isUnderODKFolder(exportDirectory)) {
        ODKOptionPane.showErrorDialog(ExportPanel.this, MessageStrings.DIR_INSIDE_ODK_DEVICE_DIRECTORY,
            MessageStrings.INVALID_EXPORT_DIRECTORY);
        return;
      } else if (isUnderBriefcaseFolder(exportDirectory)) {
        ODKOptionPane.showErrorDialog(ExportPanel.this, MessageStrings.DIR_INSIDE_BRIEFCASE_STORAGE,
            MessageStrings.INVALID_EXPORT_DIRECTORY);
        return;
      }
      ...
      if (lfd.isFileEncryptedForm() || lfd.isFieldEncryptedForm()) {
        ...
        if (!pemFile.exists()) {
          ODKOptionPane.showErrorDialog(ExportPanel.this,
              "Briefcase action failed: No PrivateKey file for encrypted form", MessageStrings.ERROR_DIALOG_TITLE);
          return;
        }
      }
      ...
      if (fromDate != null && toDate != null && fromDate.compareTo(toDate) > 0) {
        ODKOptionPane.showErrorDialog(ExportPanel.this, MessageStrings.INVALID_DATE_RANGE_MESSAGE,
      ...
      try {
        ...
        ODKOptionPane.showErrorDialog(ExportPanel.this, "Briefcase action failed: " + ex.getMessage(),
  ...
  ExportPanel(TerminationFuture terminationFuture) {
    ...
    btnCancel.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent arg0) {
        ExportPanel.this.terminationFuture.markAsCancelled(new ExportAbortEvent(TAB_NAME + " cancelled by user."));
      }
    });
    ...
    groupLayout.setHorizontalGroup(groupLayout.createSequentialGroup()
        ...
        .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
            .addGroup(groupLayout.createSequentialGroup()
                ...
                .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                    .addComponent(comboBoxForm, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
                    .addComponent(comboBoxExportType, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
                    .addGroup(groupLayout.createSequentialGroup()
    ...
    groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
        .addGroup(groupLayout.createSequentialGroup()
            ...
            .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
                .addComponent(comboBoxForm, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE,
                    GroupLayout.PREFERRED_SIZE)
                .addComponent(lblForm))
            .addPreferredGap(ComponentPlacement.RELATED)
            .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
                .addComponent(comboBoxExportType, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE,
                    GroupLayout.PREFERRED_SIZE)
                .addComponent(lblExportType))
            .addPreferredGap(ComponentPlacement.RELATED)
            .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
                .addComponent(lblExportDirectory)
                .addComponent(btnChooseExportDirectory)
                .addComponent(txtExportDirectory, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE,
                    GroupLayout.PREFERRED_SIZE))
            .addPreferredGap(ComponentPlacement.RELATED)
            .addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
                .addComponent(lblPemPrivateKey)
                .addComponent(pemPrivateKeyFilePath, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE,
                    GroupLayout.PREFERRED_SIZE)
                .addComponent(btnPemFileChooseButton))
            .addPreferredGap(ComponentPlacement.RELATED)
            .addPreferredGap(ComponentPlacement.RELATED)
            ...
            .addPreferredGap(ComponentPlacement.RELATED)
            .addGroup(
                groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(lblDateTo).addComponent(pickEndDate))
  ...
  void updateComboBox() {
    final BriefcaseFormDefinition selectedForm =
        comboBoxForm.getSelectedIndex() == -1 ? null : (BriefcaseFormDefinition) comboBoxForm.getSelectedItem();
