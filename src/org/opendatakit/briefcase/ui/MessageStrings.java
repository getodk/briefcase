...
public class MessageStrings {
  ...
  public static final String BRIEFCASE_STORAGE_LOCATION = "Storage Location";
  public static final String ODK_DIRECTORY = "ODK Directory";
  ...
  public static final String DIR_NOT_ODK_COLLECT_DIRECTORY = "Not an ODK Collect directory (did not find both the forms and instances child directories)";
  public static final String INVALID_ODK_DIRECTORY = "Invalid " + ODK_DIRECTORY;
  public static final String INVALID_BRIEFCASE_STORAGE_LOCATION = "Invalid " + BRIEFCASE_STORAGE_LOCATION;
  public static final String INVALID_EXPORT_DIRECTORY = "Invalid " + EXPORT_DIRECTORY;
  ...
  public static final String INVALID_PEM_FILE = "Invalid Private Key (PEM) File";

  public static final String INVALID_PEM_FILE_DIALOG_TITLE = "Invalid Private Key (PEM) File";
  static final String BRIEFCASE_WELCOME = "Please set the path in your file system where Briefcase should create its\n"
  ...
  public static final String ERROR_DIALOG_TITLE = "ODK Briefcase Action Failed";
  ...
  public static final String PROXY_SET_ADVICE = "If you are behind a proxy, try setting up your proxy details through 'Settings' tab.";
