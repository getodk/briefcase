...
public class BriefcasePreferences {
  ...
  private static class Preference {
    private static final BriefcasePreferences APPLICATION_SCOPED = new BriefcasePreferences(BriefcasePreferences.class,
  ...
  public static HttpHost getBriefCaseProxyConnection() {
    ...
    if (host != null) {
      Integer port = Integer.parseInt(Preference.APPLICATION_SCOPED.get(BRIEFCASE_PROXY_PORT_PROPERTY, "0"));
