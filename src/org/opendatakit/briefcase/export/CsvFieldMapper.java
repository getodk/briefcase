 ...
 * <p>
 * The {@link CsvFieldMapper#apply(String, Path, Model, Optional, Path, boolean, boolean)} returns
 ...
 * <p>
 * Normally, the {@link CsvFieldMapper#apply(String, Path, Model, Optional, Path, boolean, boolean)} should return just a
...
interface CsvFieldMapper {
  ...
  Stream<Pair<String, String>> apply(String localId, Path workingDir, Model model, Optional<XmlElement> maybeElement, Path exportMediaPath, boolean exportMedia, boolean explodeChoiceLists);
}
