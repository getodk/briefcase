 ...
 * <p>
 * The {@link CsvFieldMapper#apply(String, Path, Model, Optional, Path, boolean, boolean, ExportConfiguration)} returns
 ...
 * <p>
 * Normally, the {@link CsvFieldMapper#apply(String, Path, Model, Optional, Path, boolean, boolean, ExportConfiguration)} should return just a
...
interface CsvFieldMapper {
  ...
  Stream<Pair<String, String>> apply(String localId, Path workingDir, Model model, Optional<XmlElement> maybeElement, Path exportMediaPath, boolean exportMedia, boolean explodeChoiceLists, ExportConfiguration configuration);
}
