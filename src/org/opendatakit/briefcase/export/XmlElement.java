...
public class XmlElement {
  ...
  String getParentLocalId(String instanceId) {
    ...
    return parent.getParentLocalId(instanceId) + "/" + parent.getName() + "[" + parent.getPlaceAmongSameTagSiblings() + "]";
  }
  ...
  String getCurrentLocalId(String instanceId) {
    if (isFirstLevelGroup())
      return instanceId + "/" + getName() + "[" + getPlaceAmongSameTagSiblings() + "]";
    return getParent().getCurrentLocalId(instanceId) + "/" + getName() + "[" + getPlaceAmongSameTagSiblings() + "]";
  }
  ...
  String getGroupLocalId(String instanceId) {
    if (isFirstLevelGroup())
      return instanceId + "/" + getName();
    XmlElement parent = getParent();
    return parent.getGroupLocalId(instanceId) + "[" + parent.getPlaceAmongSameTagSiblings() + "]/" + getName();
  }
   ...
   * <p>
   * If no value is found, this method will throw.
   *
