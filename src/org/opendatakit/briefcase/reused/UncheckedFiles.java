...
public class UncheckedFiles {
  ...
  public static void write(Path outputFile, Stream<String> lines, OpenOption... options) {
    try {
      Files.write(outputFile, (Iterable<String>) lines::iterator, options);
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  }

  public static void write(Path outputFile, byte[] bytes, OpenOption... options) {
    try {
      Files.write(outputFile, bytes, options);
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public static Stream<Path> walk(Path dir) {
    try {
      return Files.exists(dir) ? Files.walk(dir) : Stream.empty();
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public static Path createDirectories(Path path, FileAttribute<?>... attrs) {
    try {
      ...
      // TODO Probably anonymize any path shown in this exception's message
      throw new BriefcaseException("Can't create directories", e);
    }
  }
  ...
  public static Path copy(Path source, Path target, CopyOption... options) {
    try {
      ...
      throw new BriefcaseException("Can't copy that path", e);
    }
  }
  ...
  public static byte[] readAllBytes(Path path) {
    try {
      ...
      throw new RuntimeException("Can't read all bytes of that", e);
    }
  }
