...
class ServerError<T> implements Response<T> {
  ...
  private ServerError(int statusCode, String statusPhrase, String serverErrorResponse) {
    this.statusCode = statusCode;
    this.statusPhrase = statusPhrase;
    this.serverErrorResponse = serverErrorResponse;
  }

  static <U> ServerError<U> from(Request<U> request, HttpResponse response) {
  ...
  public <U> Response<U> map(Function<T, U> outputMapper) {
    return new ServerError<>(statusCode, statusPhrase, serverErrorResponse);
  }
