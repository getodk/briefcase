...
public final class HtmlConsts {
  ...
  public static final String PAGE_HEADING_TABLE_OPEN = BEGIN_OPEN_TAG + TABLE + PAGE_HEADING_TABLE_PROPERTIES + END_TAG;
  public static final String HEADING_TABLE_OPEN = BEGIN_OPEN_TAG + TABLE + HEADING_TABLE_PROPERTIES + END_TAG;
  ...
  public static final String TABLE_ROW_OPEN = HtmlStrUtil.createBeginTag(TABLE_ROW);
  public static final String TABLE_ROW_CLOSE = HtmlStrUtil.createEndTag(TABLE_ROW);
  public static final String TABLE_DATA_CLOSE = HtmlStrUtil.createEndTag(TABLE_DATA);
