...
public class Cli {
  ...
  /**
   * Always run an {@link Operation} before any other {@link Operation} is run
   *
   * @param operation an {@link Operation} instance. It doesn't need to have a main {@link Param}
